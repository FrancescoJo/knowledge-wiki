...
export function pmView(editor: TextEdit) { return (editor as any).editor.view }

export function pmState(editor: TextEdit) { return pmView(editor).state }

// eslint-disable-next-line @typescript-eslint/no-explicit-any
export function getDoc(editor: TextEdit) { return editor.getContent() as any }
...
export function rect(x: number, y: number, w: number, h: number): DOMRect {
  return { left: x, top: y, right: x + w, bottom: y + h, width: w, height: h, x, y, toJSON() { return this } } as DOMRect
}
