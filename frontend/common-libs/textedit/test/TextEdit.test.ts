    ...
    content: [
      ...
      },
      {
        ...
        content: [
          ...
          {
            type: NodeType.TableCell,
            content: [{type: NodeType.Paragraph, content: [{type: NodeType.Text, text: '5'}]}]
          },
          {
            type: NodeType.TableCell,
            content: [{type: NodeType.Paragraph, content: [{type: NodeType.Text, text: '6'}]}]
          },
        ],
      },
    ],
    ...
    content: [
      {
        ...
        content: [
          {
            type: NodeType.TableCell,
            content: [{type: NodeType.Paragraph, content: [{type: NodeType.Text, text: 'cherry'}]}]
          },
          {
            type: NodeType.TableCell,
            content: [{type: NodeType.Paragraph, content: [{type: NodeType.Text, text: '3'}]}]
      ...
      },
      {
        ...
        content: [
          {
            type: NodeType.TableCell,
            content: [{type: NodeType.Paragraph, content: [{type: NodeType.Text, text: 'banana'}]}]
          },
          {
            type: NodeType.TableCell,
            content: [{type: NodeType.Paragraph, content: [{type: NodeType.Text, text: '2'}]}]
    ...
    content: [
      {
        ...
        content: [
          {
            type: NodeType.TableHeader,
            content: [{type: NodeType.Paragraph, content: [{type: NodeType.Text, text: 'Name'}]}]
          },
        ],
      },
      {
        ...
        content: [
          {
            type: NodeType.TableCell,
            content: [{type: NodeType.Paragraph, content: [{type: NodeType.Text, text: 'only row'}]}]
          },
        ],
      },
    ],
